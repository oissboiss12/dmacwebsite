    ...
    return (
        <div className="min-h-screen bg-black text-white"> 
            ...
            <div className="p-8 bg-[#758D40] bg-opacity-75 py-4">
                <h2 className="title-size"> Rolling Road Brake Testing </h2>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between">
                 ...
                 {/* Content */}
            <div className="p-8 bg-[#758D40] bg-opacity-75 py-4 mt-8">
                <h2 className="title-size"> Truck and Trailer Diagnostics </h2>
                <div className="bg-[#758D40] bg-opacity-50">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <p className="w-full md:w-1/2 text-size custom-margin mt-4">
                    We hire skilled fabricators to assemble strutural steel and aluminium to commercial trailers. 
                 ...
                 {/* Content */}
            <div className="p-8 bg-[#758D40] bg-opacity-75 py-4 mt-8">
                <h2 className="title-size"> Safety Inspections </h2>
                <div className="bg-[#758D40] bg-opacity-50">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <p className="w-full md:w-1/2 text-size custom-margin mt-4">
                    We hire skilled fabricators to assemble strutural steel and aluminium to commercial trailers. 
                 ...
                 {/* Content */}
            <div className="p-8 bg-[#758D40] bg-opacity-75 py-4 mt-8">
                <h2 className="title-size"> Service Checks and Refurbishments </h2>
                <div className="bg-[#758D40] bg-opacity-50">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <p className="w-full md:w-1/2 text-size custom-margin mt-4">
                    We hire skilled fabricators to assemble strutural steel and aluminium to commercial trailers. 
