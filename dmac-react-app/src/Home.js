...
const Home = () => {
  return (
    ...
    <div className="flex container bg-gray-900 p-4 shadow-md space-x-4">
      <div className="flex flex-col w-1/3 bg-green-700 p-4 border-2 border-gray-900">
      ...
      <div className="flex items-center justify-center w-1/3 bg-gray-900 p-2 container-bg">
